...
public:
     ...
     */
    template <typename T>
    Base& group_by(int32_t(*rank)(flecs::world_t*, flecs::type_t type, flecs::id_t)) {
     ...
     * @param rank The rank action.
     */
    Base& group_by(flecs::entity_t component, int32_t(*rank)(flecs::world_t*, flecs::type_t type, flecs::id_t)) {
